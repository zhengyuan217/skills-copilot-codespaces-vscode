#This code utilizes LlamaIndex to implement RAG with reranking to improve output results. More complicated tasks may be implemented through construction of workflow via branching and looping. Locally-hosted LLM models are used an an example here. contact: wzhengyuan@gmail.com 202504
import os, sys
